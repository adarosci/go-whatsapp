...
func CheckCurrentServerVersion(bufferOptions ...int) ([]int, error) {
	...
	login := []interface{}{"admin", "init", waVersion, []string{wac.longClientName, wac.shortClientName, wac.versionClientName}, b64ClientId, true}
...
func (wac *Conn) SetClientName(long, short, version string) error {
	...
	wac.longClientName, wac.shortClientName, wac.versionClientName = long, short, version
	return nil
}
...
func (wac *Conn) Login(qrChan chan<- string) (Session, error) {
	...
	login := []interface{}{"admin", "init", waVersion, []string{wac.longClientName, wac.shortClientName, wac.versionClientName}, session.ClientId, true}
	loginChan, err := wac.writeJson(login)
	if err != nil {
...
func (wac *Conn) Restore() error {
	...
	//admin init
	init := []interface{}{"admin", "init", waVersion, []string{wac.longClientName, wac.shortClientName, wac.versionClientName}, wac.session.ClientId, true}
